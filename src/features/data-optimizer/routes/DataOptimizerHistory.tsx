...
const history: DataOptimizerHistory[] = [
  {
    id: 1,
    crm: "hubspot",
    module: "contact",
...
export default function DataOptimizerHistory() {
  const [searchValues, setSearchValue] = useState("");
  const columns = useMemo<ColumnDef<DataOptimizerHistory>[]>(
    () => [
      {
        header: "CRM",
